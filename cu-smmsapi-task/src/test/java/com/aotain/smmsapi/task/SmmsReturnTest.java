...
public class SmmsReturnTest {
	...
	public void serviceApiTest() {
		init();
		// 加载项目配置															 
		IDemoService idemo = BaseFeignBuilder.getCacheFeign(IDemoService.class, "myclient", new DemoServiceHystrix(),BaseFeignBuilder.EncodeDecodeType.EDT_JSON_JSON,null);
	...
	public void preinputApiTest() {
		...
		IPreinputService ipService = BaseFeignBuilder.getCacheFeign(IPreinputService.class,
				IPreinputService.CLIENT_NAME, new PreinputServiceFallback(),EncodeDecodeType.EDT_PLAIN_JSON,null);
