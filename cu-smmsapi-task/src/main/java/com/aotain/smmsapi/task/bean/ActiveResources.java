...
public class ActiveResources {
    ...
    protected List<ActiveResources.FindDomainList> findDomainList;
    protected List<ActiveResources.FindIpList> findIpList;
     ...
     * {@link ActiveResources.FindDomainList }
     * 
     * 
     */
    public List<ActiveResources.FindDomainList> getFindDomainList() {
        if (findDomainList == null) {
            findDomainList = new ArrayList<ActiveResources.FindDomainList>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ActiveResources.FindIpList }
     * 
     * 
     */
    public List<ActiveResources.FindIpList> getFindIpList() {
        if (findIpList == null) {
            findIpList = new ArrayList<ActiveResources.FindIpList>();
        }
