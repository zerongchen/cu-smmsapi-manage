...
public class LogQueryResult {
    ...
    @XmlElement(required = true)
    protected LogQueryResult.Result result;
    protected List<LogQueryResult.Log> log;
    @XmlElement(required = true)
     ...
     * @return
     *     possible object is
     *     {@link LogQueryResult.Result }
     *     
     */
    public LogQueryResult.Result getResult() {
        return result;
    }
     ...
     *     
     */
    public void setResult(LogQueryResult.Result value) {
        this.result = value;
    }
     ...
     * {@link LogQueryResult.Log }
     * 
     * 
     */
    public List<LogQueryResult.Log> getLog() {
        if (log == null) {
            log = new ArrayList<LogQueryResult.Log>();
        }
        return this.log;
    }
