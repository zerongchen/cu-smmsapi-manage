...
public class FilterResult {
    ...
    @XmlElement(required = true)
    protected List<FilterResult.Log> log;
    @XmlElement(required = true)
     ...
     * {@link FilterResult.Log }
     * 
     * 
     */
    public List<FilterResult.Log> getLog() {
        if (log == null) {
            log = new ArrayList<FilterResult.Log>();
        }
        return this.log;
    }
    ...
    public static class Log {
        ...
        protected List<FilterResult.Log.Attachment> attachment;
        @XmlElement(required = true)
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link FilterResult.Log.Attachment }
         * 
         * 
         */
        public List<FilterResult.Log.Attachment> getAttachment() {
            if (attachment == null) {
                attachment = new ArrayList<FilterResult.Log.Attachment>();
            }
